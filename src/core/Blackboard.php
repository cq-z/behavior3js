...
class Blackboard extends Behavior3 {

    public $_baseMemory=array();
    public $_treeMemory=array();
     ...
     * @protected
     **/
    public function &_getTreeMemory($treeScope) {
        if (!$this->_treeMemory[$treeScope]) {
            $this->_treeMemory[$treeScope] = array(
                'nodeMemory'         => array(),
                'openNodes'          => array(),
                'traversalDepth'     => 0,
                'traversalCycle'     => 0,
     ...
     * @protected
     **/
    public function &_getNodeMemory (&$treeMemory, $nodeScope) {
        $memory = &$treeMemory['nodeMemory'];
        if (!$memory[$nodeScope]) {
            $memory[$nodeScope] = array();
        }
     ...
     * @protected
     **/
    public function &_getMemory ($treeScope, $nodeScope) {
     ...
     **/
    public function set ($key, $value, $treeScope=null, $nodeScope=null) {
     ...
     **/
    public function get($key, $treeScope=null, $nodeScope=null) {
